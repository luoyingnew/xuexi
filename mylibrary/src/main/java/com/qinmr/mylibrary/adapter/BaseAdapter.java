package com.qinmr.mylibrary.adapter;
...
import com.qinmr.mylibrary.listener.ItemTouchHelperAdapter;
...
import com.qinmr.mylibrary.listener.OnRecyclerViewItemLongClickListener;
import com.qinmr.mylibrary.listener.OnRemoveDataListener;
import com.qinmr.mylibrary.listener.OnRequestDataListener;
import com.qinmr.mylibrary.listener.OnStartDragListener;
import com.qinmr.mylibrary.listener.SimpleItemTouchHelperCallback;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            default:
                ...
                setDragFixBackground(holder, position);
                break;
        }
    }
...
//                ViewGroup.LayoutParams.MATCH_PARENT));
     ...
     * @param position
     */
    private void setDragFixBackground(RecyclerView.ViewHolder holder, int position) {
