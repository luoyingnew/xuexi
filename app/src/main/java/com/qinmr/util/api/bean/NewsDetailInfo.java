...
public class NewsDetailInfo implements Serializable {
    ...
    public static class SpinfoEntity  implements Serializable{
        private String ref;
    ...
    public static class TopiclistNewsEntity implements Serializable {
    ...
    public static class HuatiEntity  implements Serializable{
