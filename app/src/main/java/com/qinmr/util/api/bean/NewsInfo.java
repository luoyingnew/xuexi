package com.qinmr.util.api.bean;
 ...
 * 新闻实体
 */
public final class NewsInfo implements Parcelable, Serializable {
    ...
    public static class AdData implements Parcelable ,Serializable{
        private String title;
        private String tag;
        private String imgsrc;
    ...
    public static class ImgExtraData implements Serializable{
        private String imgsrc;
